...
def alpaka(x, y, k, n):
    ...
    if (n == 1):
        ...
        arc(screen, (255, 0, 0), (x+5*k, y-20*k, 12*k, 25*k), np.pi, 3*np.pi/2, 2) #рог 1
        arc(screen, (255, 0, 0), (x, y-25*k, 12*k, 32*k), np.pi, 3*np.pi/2, 2) #рог 2
        ...
        arc(screen, (255, 0, 0), (x-5*k-12*k, y-20*k, 12*k, 25*k), 3*np.pi/2, 2*np.pi, 2) #рог 1
        arc(screen, (255, 0, 0), (x-12*k, y-25*k, 12*k, 32*k), 3*np.pi/2, 2*np.pi, 2) #рог 2
