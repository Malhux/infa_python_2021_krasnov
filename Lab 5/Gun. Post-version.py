...
class Bunny:
    ...
    def draw(self):
        ...
        addscreen = pygame.image.load('desktop/Labs Python/Lab 5/dabunnae.png')
...
# images:
bombImg = pygame.image.load('desktop/Labs Python/Lab 5/dabomb.png')
gunImg = pygame.image.load('desktop/Labs Python/Lab 5/dagun.png')
tankImg = pygame.image.load('desktop/Labs Python/Lab 5/datank.png')
menubombImg = pygame.image.load('desktop/Labs Python/Lab 5/bomb_mode.png')
menuballImg = pygame.image.load('desktop/Labs Python/Lab 5/ball_mode.png')
bombexposionImg = pygame.image.load('desktop/Labs Python/Lab 5/dabombexplosion.png')
bunnyexplosionImg = pygame.image.load('desktop/Labs Python/Lab 5/daexplosion.png')
